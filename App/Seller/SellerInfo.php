...
<head>
    ...
    <link rel="stylesheet" href="../css/style-selleruserprofile.css" />
</head>
...
require_once '../Service/UserService.php';
    ...
    if (isset($_GET['id'])) {
        ...
        if ($user) {
            ...
            echo "<tr><th>Credito</th><td><span id='credit'>" . htmlspecialchars($user->getCredit()) . "</span><input type='hidden' name='credit' value='" . htmlspecialchars($user->getCredit()) . "'></td>";
